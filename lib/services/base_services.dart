...
abstract class BaseServices {
  ...
  Future<List<Product>?> getProductsByIds(List<String> ids) => Future.value([]);
  ...
  Future<Prediction> getPlaceDetail(
    ...
    try {
      var endpoint = 'https://maps.googleapis.com/maps/api/place/details/json?'
          ...
          '&fields=geometry&key=${isIos ? DefaultConfig.googleApiKey.ios : DefaultConfig.googleApiKey.android}'
