...
import 'product_list_custom/product_list_custom_layout.dart';
import 'shipping_type/shipping_type_layout.dart';
...
import 'wishlist/wishlist_layout.dart';
...
class DynamicLayout extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    print("config['layout'] ${config['layout']}");
    if (useDesktopStyle) {
    ...
    switch (config['layout']) {
      ...
      case Layout.wishlist:
        return const WishListLayout();
      case Layout.listProductCustom:
        return ProductListCustomLayout(
          config: ProductListCustomConfig.fromJson(config),
        );
      case Layout.shippingType:
        return const ShippingTypeLayout();
      default:
