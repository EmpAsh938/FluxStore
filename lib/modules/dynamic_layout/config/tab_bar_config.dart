...
const _kDefaultBottomBarStyle = BottomBarStyle.static;
...
class TabBarConfig {
  ...
  TabBarConfig({
    ...
    BottomBarStyle bottomBarStyle = _kDefaultBottomBarStyle,
  }) : _bottomBarStyle = bottomBarStyle;
  ...
  TabBarConfig copyWith({
    ...
    return TabBarConfig(
      ...
      showMinimize: showMinimize ?? this.showMinimize,
      alwaysShowTabBar: alwaysShowTabBar ?? this.alwaysShowTabBar,
      isSafeArea: isSafeArea ?? this.isSafeArea,
      showFloating: showFloating ?? this.showFloating,
      showFloatingClip: showFloatingClip ?? this.showFloatingClip,
      enableOnTop: enableOnTop ?? this.enableOnTop,
      enableDivider: enableDivider ?? this.enableDivider,
      ...
      colorCart: colorCart ?? this.colorCart,
      colorIcon: colorIcon ?? this.colorIcon,
      colorActiveIcon: colorActiveIcon ?? this.colorActiveIcon,
