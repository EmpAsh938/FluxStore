...
class _ProductListState extends State<ProductList> {
  ...
  Widget build(BuildContext context) {
    ...
    print('...widget.layout...${widget.layout}');
    if (productsList == null || productsList.isEmpty) {
      ...
      if (widget.layout != Layout.pinterest) {
        if (widget.layout == Layout.listTile ||
          ...
          if (widget.layout == Layout.columns) {
            ...
            typeList = buildGridViewProduct(
              childAspectRatio:
                  double.parse(childAspectRatio.toStringAsFixed(1).toString()),
              crossAxisCount: crossAxisCount,
              products: productsList,
              widthContent: widthContent,
            );
      ...
      delegate: SliverChildBuilderDelegate(
        ...
        (BuildContext context, int i) {
          return Services().widget.renderProductCardView(
                ...
                config:
                    ProductConfig.empty().copyWith(imageBoxfit: BoxFit.contain)
                      ..showHeart = true
    ...
    return SliverPadding(
      ...
      sliver: SliverMasonryGrid.count(
        ...
        itemBuilder: (context, index) => PinterestCard(
          ...
          config: ProductConfig.empty().copyWith(imageBoxfit: BoxFit.contain)
            ..showCartIcon = ProductConfig.empty().showCartIcon &&
        ...
        (context, index) {
          if (widget.layout == Layout.simpleList) {
            return ProductSimpleView(
              ...
              config: ProductConfig.empty().copyWith(
