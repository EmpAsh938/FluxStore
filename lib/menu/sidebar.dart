...
import 'package:flux_extended/store_locator/views/stores_map_view.dart';
...
import '../modules/vendor_on_boarding/vendor_information/vendor_location_information_screen.dart';
import '../routes/flux_navigate.dart';
import '../screens/store_locator/store_locator.dart';
...
class MenuBarState extends State<SideBarMenu> {
          ...
          child: Column(
            ...
            children: [
              ...
              ListTile(
                ...
                onTap: () {
                  // https://hakkaexpress.com/storelocator/
  ...
  Widget renderStoreLocator(instagramLink, BuildContext context) {
    ...
    //   factoryBuilder: StoreLocatorWidgetFactory.new,
    // );
  }
...
// class StoreLocatorWidgetFactory extends core.WidgetFactory with WebViewFactory {
//   @override
