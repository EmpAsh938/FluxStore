...
mixin OverrideTranslateMixin on OverrideTranslateActionMixin implements S {
  ...
  /// `Pickup`
  @override
  String get pickup => getCustomTranslate('pickup', parent.pickup);

  /// `Delivery`
  @override
  String get delivery => getCustomTranslate('delivery', parent.delivery);

  /// `Select Hakka Location`
  @override
  String get selectHakkaLocation =>
      getCustomTranslate('selectHakkaLocation', parent.selectHakkaLocation);

  /// `Pick Up Or Delivery`
  @override
  String get pickupOrDelivery =>
      getCustomTranslate('pickupOrDelivery', parent.pickupOrDelivery);

  /// `Address To Pickup`
  @override
  String get addressToPickup =>
      getCustomTranslate('addressToPickup', parent.addressToPickup);

  /// `Coming Soon`
  @override
  String get comingSoon => getCustomTranslate('comingSoon', parent.comingSoon);
