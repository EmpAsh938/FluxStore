...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(size) => "Dimensione massima del file: ${size} MB";

  static String m24(currency, amount) =>
      "L\'importo minimo per l\'utilizzo di questo pagamento è ${currency} ${amount}";

  static String m25(minute) => "${minute} minuti fa";

  static String m26(month) => "${month} mesi fa";

  static String m27(store) => "Altro da ${store}";

  static String m28(number) => "deve essere acquistato in gruppi di ${number}";

  static String m29(itemCount) => "${itemCount} prodotti";

  static String m30(price) => "Opzioni totali: ${price}";

  static String m31(amount) => "Paga ${amount}";

  static String m32(name) =>
      "${name} sono stati aggiunti al carrello con successo";

  static String m33(total) => "Qtà: ${total}";

  static String m35(percent) => "${percent}% di sconto";

  static String m36(keyword) => "Risultati della ricerca per: \'${keyword}\'";

  static String m37(keyword, count) => "${keyword} (${count} elemento)";

  static String m38(keyword, count) => "${keyword} (${count} elementi)";

  static String m39(second) => "${second} secondi fa";
  ...
  static String m42(fieldName) => "Il campo ${fieldName} è obbligatorio";

  static String m43(total) => "${total} Prodotti";
  ...
  static String m46(date) => "Valido fino alle ${date}";

  static String m48(message) => "Attenzione: ${message}";
  ...
  static String m50(length) => "Abbiamo trovato \$length prodotti";

  static String m51(week) => "Settimana ${week}";

  static String m52(name) => "Benvenuto ${name}";

  static String m53(year) => "${year} anni fa";

  static String m54(total) => "Hai assegnato all\'ordine #${total}";
