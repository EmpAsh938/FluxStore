...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(size) => "Maximale bestandsgrootte: ${size} MB";

  static String m24(currency, amount) =>
      "Het minimumbedrag voor het gebruik van deze betaling is ${currency} ${amount}";

  static String m25(minute) => "${minute} minuten geleden";

  static String m26(month) => "${month} maanden geleden";

  static String m27(store) => "Meer van ${store}";

  static String m28(number) => "moet worden gekocht in groepen van ${number}";

  static String m29(itemCount) => "${itemCount} items";

  static String m30(price) => "Opties totaal: ${price}";

  static String m31(amount) => "Betaal ${amount}";

  static String m32(name) =>
      "${name} zijn succesvol aan winkelwagen toegevoegd";

  static String m33(total) => "Aantal: ${total}";

  static String m35(percent) => "Verkoop ${percent} %";

  static String m36(keyword) => "Zoekresultaten voor: \'${keyword}\'";

  static String m37(keyword, count) => "${keyword} (${count} artikel)";

  static String m38(keyword, count) => "${keyword} (${count} artikelen)";

  static String m39(second) => "${second} seconden geleden";

  static String m40(totalCartQuantity) =>
      "Winkelwagen, ${totalCartQuantity} artikelen";

  static String m41(numberOfUnitsSold) => "Verkocht: ${numberOfUnitsSold}";

  static String m42(fieldName) => "Het veld ${fieldName} is verplicht";

  static String m43(total) => "${total} producten";
  ...
  static String m46(date) => "Geldig tot ${date}";

  static String m48(message) => "Waarschuwing: ${message}";
  ...
  static String m50(length) => "We hebben ${length} producten gevonden";

  static String m51(week) => "Week ${week}";

  static String m52(name) => "Welkom ${name}";

  static String m53(year) => "${year} jaar geleden";

  static String m54(total) => "Je hebt toegewezen aan bestelling #${total}";
