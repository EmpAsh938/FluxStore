...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m25(minute) => " for${minute} minutter siden";

  static String m26(month) => " for${month} måneder siden";

  static String m27(store) => "Mere fra ${store}";

  static String m28(number) => "skal købes i grupper af ${number}";

  static String m29(itemCount) => "${itemCount} elementer";

  static String m30(price) => "Indstillinger i alt: ${price}";

  static String m31(amount) => "Betal ${amount}";

  static String m32(name) => "${name} er blevet tilføjet til indkøbskurven";

  static String m33(total) => "Antal: ${total}";

  static String m35(percent) => "Udsalg ${percent}%";

  static String m36(keyword) => "Søgeresultater for: \'${keyword}\'";

  static String m37(keyword, count) => "${keyword} (${count} element)";

  static String m38(keyword, count) => "${keyword} (${count} elementer)";

  static String m39(second) => " for${second} sekunder siden";
  ...
  static String m42(fieldName) => "Feltet ${fieldName} er påkrævet";
  ...
  static String m50(length) => "Vi fandt ${length} produkter";

  static String m51(week) => "Uge ${week}";

  static String m52(name) => "Velkommen ${name}";

  static String m53(year) => " for${year} år siden";

  static String m54(total) => "Du har tildelt ordrenummer${total}";
