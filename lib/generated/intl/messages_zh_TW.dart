...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m21(message) => "請求數據時應用出現問題，請聯繫管理員解決問題： ${message}";

  static String m22(currency, amount) => "使用此付款的最大金額為 ${currency} ${amount}";

  static String m23(size) => "最大文件大小： ${size} MB";

  static String m24(currency, amount) => "使用此付款的最低金額為 ${currency} ${amount}";

  static String m25(minute) => "${minute} 分鐘前";

  static String m26(month) => "${month} 個月前";

  static String m27(store) => " ${store}的更多內容";

  static String m28(number) => "必須以 ${number}為一組購買";

  static String m29(itemCount) => "${itemCount} 項";

  static String m30(price) => "選項總數： ${price}";

  static String m31(amount) => "支付 ${amount}";

  static String m32(name) => "${name} 已成功加入購物車";

  static String m33(total) => "數量： ${total}";

  static String m35(percent) => "銷售額 ${percent}%";

  static String m36(keyword) => "搜尋結果：“${keyword}”";

  static String m37(keyword, count) => "${keyword} （${count} 項）";

  static String m38(keyword, count) => "${keyword} （${count} 項）";

  static String m39(second) => "${second} 秒前";

  static String m40(totalCartQuantity) => "購物車， ${totalCartQuantity} 件商品";

  static String m41(numberOfUnitsSold) => "已售出： ${numberOfUnitsSold}";

  static String m42(fieldName) => " ${fieldName} 字段是必需的";

  static String m43(total) => "${total} 個商品";
  ...
  static String m50(length) => "我們找到了 ${length} 件商品";

  static String m51(week) => "第 ${week} 週";

  static String m52(name) => "歡迎 ${name}";

  static String m53(year) => "${year} 年前";

  static String m54(total) => "您已指定訂單 #${total}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "enterSentCode": MessageLookupByLibrary.simpleMessage("輸入發送到的代碼"),
