...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(size) => "ขนาดไฟล์สูงสุด: ${size} MB";

  static String m24(currency, amount) =>
      "จำนวนเงินขั้นต่ำสำหรับการชำระเงินนี้คือ ${currency} ${amount}";

  static String m25(minute) => "{นาที} นาทีที่ผ่านมา";

  static String m26(month) => "${month} เดือนที่แล้ว";

  static String m27(store) => "เพิ่มเติมจาก ${store}";

  static String m28(number) => "ต้องซื้อเป็นกลุ่มจำนวน ${number}";

  static String m29(itemCount) => "${itemCount} รายการ";

  static String m30(price) => "ตัวเลือกทั้งหมด: ${price}";

  static String m31(amount) => "ชำระเงิน ${amount}";

  static String m32(name) => " เพิ่ม${name} ลงในรถเข็นเรียบร้อยแล้ว";

  static String m33(total) => "จำนวน: ${total}";

  static String m35(percent) => "ยอดขาย ${percent} %";

  static String m36(keyword) => "ผลการค้นหาสำหรับ: \'${keyword}\'";

  static String m37(keyword, count) => "${keyword} (${count} รายการ)";

  static String m38(keyword, count) => "${keyword} (${count} รายการ)";

  static String m39(second) => "${second} วินาทีที่ผ่านมา";
  ...
  static String m42(fieldName) => "ต้องระบุช่อง ${fieldName} ";

  static String m43(total) => "${total} สินค้า";
  ...
  static String m46(date) => "ใช้ได้จนถึง ${date}";

  static String m48(message) => "คำเตือน: ${message}";
  ...
  static String m50(length) => "เราพบสินค้า ${length}";

  static String m51(week) => "สัปดาห์ ${week}";

  static String m52(name) => "ยินดีต้อนรับ ${name}";

  static String m53(year) => "${year} ปีที่แล้ว";

  static String m54(total) => "คุณได้มอบหมายคำสั่งซื้อ #${total}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "recent": MessageLookupByLibrary.simpleMessage("ล่าสุด"),
        "recentSearches":
