...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(size) => "Maximum file size: ${size} MB";

  static String m24(currency, amount) =>
      "The minimum amount for using this payment is ${currency} ${amount}";

  static String m25(minute) => "${minute} minutes ago";

  static String m26(month) => "${month} months ago";

  static String m27(store) => "More from ${store}";

  static String m28(number) => "must be bought in groups of ${number}";

  static String m29(itemCount) => "${itemCount} items";

  static String m30(price) => "Options total: ${price}";

  static String m31(amount) => "Pay ${amount}";

  static String m32(name) => "${name} have been added to cart successfully";

  static String m33(total) => "Qty: ${total}";

  static String m34(name) => "Received money from ${name}";

  static String m35(percent) => "Sale ${percent}%";

  static String m36(keyword) => "Search results for: \'${keyword}\'";

  static String m37(keyword, count) => "${keyword} (${count} item)";

  static String m38(keyword, count) => "${keyword} (${count} items)";

  static String m39(second) => "${second} seconds ago";
  ...
  static String m42(fieldName) => "The ${fieldName} field is required";

  static String m43(total) => "${total} products";

  static String m44(name) => "Transfer money to ${name}";
  ...
  static String m47(balance) => "Wallet balance: ${balance}";

  static String m48(message) => "Warning: ${message}";
  ...
  static String m50(length) => "We found ${length} products";

  static String m51(week) => "Week ${week}";

  static String m52(name) => "Welcome ${name}";

  static String m53(year) => "${year} years ago";

  static String m54(total) => "You have assigned to order #${total}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "addressToPickup":
            MessageLookupByLibrary.simpleMessage("Address To Pickup"),
        ...
        "pickupOrDelivery":
            MessageLookupByLibrary.simpleMessage("Pick Up Or Delivery"),
        ...
        "selectHakkaLocation":
            MessageLookupByLibrary.simpleMessage("Select Hakka Location"),
