...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(size) => "최대 파일 크기 : ${size} MB";

  static String m24(currency, amount) =>
      "이 결제를 사용하기 위한 최소 금액은 ${currency} ${amount}입니다.";

  static String m25(minute) => "${minute} 분 전";

  static String m26(month) => "${month} 개월 전";

  static String m27(store) => " ${store}에서 더보기";

  static String m28(number) => " ${number}그룹으로 구매해야 합니다.";

  static String m29(itemCount) => "${itemCount} 항목";

  static String m30(price) => "총 옵션 : ${price}";

  static String m31(amount) => " ${amount}지불";

  static String m32(name) => "${name} 이(가) 장바구니에 성공적으로 추가되었습니다";

  static String m33(total) => "수량: ${total}";

  static String m35(percent) => "판매 ${percent} %";

  static String m36(keyword) => "검색 결과: \'${keyword}\'";

  static String m37(keyword, count) => "${keyword} (${count} 개 항목)";

  static String m38(keyword, count) => "${keyword} (${count} 개 항목)";

  static String m39(second) => "${second} 초 전";

  static String m40(totalCartQuantity) => "장바구니, ${totalCartQuantity} 개 항목";

  static String m41(numberOfUnitsSold) => "판매 : ${numberOfUnitsSold}";

  static String m42(fieldName) => " ${fieldName} 필드는 필수 항목입니다.";

  static String m43(total) => "${total} 제품";

  static String m45(maxPointDiscount, maxPriceDiscount) =>
      "이 주문에 ${maxPriceDiscount} 할인을 위해 최대 ${maxPointDiscount} 포인트를 사용하세요!";

  static String m46(date) => " ${date}까지 유효";

  static String m48(message) => "경고 : ${message}";

  static String m49(defaultCurrency) =>
      "현재 선택한 통화는 지갑 기능에 사용할 수 없습니다. ${defaultCurrency}(으)로 변경하십시오.";

  static String m50(length) => " ${length} 개의 제품을 찾았습니다.";

  static String m51(week) => "주 ${week}";

  static String m52(name) => "환영합니다 ${name}";

  static String m53(year) => "${year} 년 전";

  static String m54(total) => "주문 번호${total}에 할당했습니다.";
