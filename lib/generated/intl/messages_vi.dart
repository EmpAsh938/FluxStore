...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m19(currentBalance) =>
  ...
  static String m23(size) => "Kích thước tệp tối đa: ${size} MB";

  static String m24(currency, amount) =>
      "Số tiền tối thiểu để sử dụng khoản thanh toán này là ${currency} ${amount}";

  static String m25(minute) => "${minute} phút trước";

  static String m26(month) => "${month} tháng trước";

  static String m27(store) => "Thêm từ ${store}";

  static String m28(number) => "phải mua theo nhóm ${number}";

  static String m29(itemCount) => "${itemCount} mặt hàng";

  static String m30(price) => "Tổng số tùy chọn: ${price}";

  static String m31(amount) => "Thanh toán ${amount}";

  static String m32(name) => "${name} đã được thêm vào giỏ hàng thành công";

  static String m33(total) => "Số lượng: ${total}";

  static String m34(name) => "Nhận tiền từ ${name}";

  static String m35(percent) => "Sale ${percent} %";

  static String m36(keyword) => "Kết quả tìm kiếm cho: \'${keyword}\'";

  static String m37(keyword, count) => "${keyword} (${count} mục)";

  static String m38(keyword, count) => "${keyword} (${count} mục)";

  static String m39(second) => "${second} giây trước";

  static String m40(totalCartQuantity) =>
      "Giỏ hàng, ${totalCartQuantity} sản phẩm";

  static String m41(numberOfUnitsSold) => "Đã bán: ${numberOfUnitsSold}";

  static String m42(fieldName) => "Trường ${fieldName} là bắt buộc";

  static String m43(total) => "${total} sản phẩm";

  static String m44(name) => "Chuyển tiền đến ${name}";
  ...
  static String m46(date) => "Có hiệu lực cho đến ${date}";

  static String m47(balance) => "Số dư trên ví: ${balance}";

  static String m48(message) => "Cảnh báo: ${message}";

  static String m49(defaultCurrency) =>
      "Đơn vị tiền tệ hiện được chọn không có sẵn cho tính năng ví, vui lòng đổi thành ${defaultCurrency}";

  static String m50(length) => "Chúng tôi tìm thấy ${length} sản phẩm";

  static String m51(week) => "Tuần ${week}";

  static String m52(name) => "Chào mừng ${name}";

  static String m53(year) => "${year} năm trước";

  static String m54(total) => "Bạn đã chỉ định đơn đặt hàng số${total}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "accountApprovalTitle":
            MessageLookupByLibrary.simpleMessage("Chờ phê duyệt"),
        ...
        "approvedRequests":
            MessageLookupByLibrary.simpleMessage("Yêu cầu được phê duyệt"),
        ...
        "cancelledRequests":
            MessageLookupByLibrary.simpleMessage("Yêu cầu đã hủy"),
        "cannotDeleteAccount":
            MessageLookupByLibrary.simpleMessage("Không thể xóa tài khoản này"),
        ...
        "emailIsRequired":
            MessageLookupByLibrary.simpleMessage("Email không được bỏ trống"),
        "emailSubscription":
        ...
        "enableForWallet":
            MessageLookupByLibrary.simpleMessage("Kích hoạt cho ví"),
        "enableVacationMode":
        ...
        "errorOnGettingPost":
            MessageLookupByLibrary.simpleMessage("Lỗi khi lấy bài viết!"),
        ...
        "insufficientBalanceMessage": m19,
        "invalidPhoneNumber":
        ...
        "noSuggestionSearch":
            MessageLookupByLibrary.simpleMessage("Không có gợi ý nào"),
        ...
        "paymentSettings":
            MessageLookupByLibrary.simpleMessage("Cài đặt thanh toán"),
        "paymentSuccessful":
        ...
        "productOutOfStock":
            MessageLookupByLibrary.simpleMessage("Sản phẩm này đã hết hàng"),
        "productOverview":
        ...
        "promptPayType":
            MessageLookupByLibrary.simpleMessage("Loại PromptPay:"),
        ...
        "sendSMSCode": MessageLookupByLibrary.simpleMessage("Nhận mã"),
        "sendSMStoVendor":
        ...
        "sizeGuide":
            MessageLookupByLibrary.simpleMessage("Hướng dẫn chọn kích thước"),
        ...
        "storeLocatorSearchPlaceholder":
            MessageLookupByLibrary.simpleMessage("Nhập địa chỉ/thành phố"),
        "storeLogo":
        ...
        "transferMoneyTo": m44,
        "transferSuccess":
            MessageLookupByLibrary.simpleMessage("Chuyển khoản thành công"),
        ...
        "withdrawRequest":
            MessageLookupByLibrary.simpleMessage("Rút lại yêu cầu"),
        ...
        "youHaveNoPost":
            MessageLookupByLibrary.simpleMessage("Bạn không có bài viết nào"),
        "youHavePoints":
