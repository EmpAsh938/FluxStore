...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(size) => "Maximální velikost souboru: ${size} MB";

  static String m24(currency, amount) =>
      "Minimální částka pro použití této platby je ${currency} ${amount}";

  static String m25(minute) => " Před${minute} minutami";

  static String m26(month) => " Před${month} měsíci";

  static String m27(store) => "Více od uživatele ${store}";

  static String m28(number) => "nutno zakoupit ve skupinách po ${number}";

  static String m29(itemCount) => " Položky:${itemCount} ";

  static String m30(price) => "Celkem možností: ${price}";

  static String m31(amount) => "Zaplatit ${amount}";

  static String m32(name) => "${name} byly úspěšně přidány do košíku";

  static String m33(total) => "Množství: ${total}";

  static String m35(percent) => "Výprodej ${percent}%";

  static String m36(keyword) => "Výsledky hledání pro: \'${keyword}\'";

  static String m37(keyword, count) => "${keyword} (${count} položka)";

  static String m38(keyword, count) => "${keyword} (počet položek:${count} )";

  static String m39(second) => " Před${second} s";

  static String m40(totalCartQuantity) =>
      "Nákupní košík, položky: ${totalCartQuantity} ";

  static String m41(numberOfUnitsSold) => "Prodáno: ${numberOfUnitsSold}";

  static String m42(fieldName) => "Pole ${fieldName} je povinné";

  static String m43(total) => "${total} produktů";
  ...
  static String m48(message) => "Upozornění: ${message}";
  ...
  static String m50(length) => "Našli jsme ${length} produktů";

  static String m51(week) => "Týden ${week}";

  static String m52(name) => "Vítejte ${name}";

  static String m53(year) => " Před${year} lety";

  static String m54(total) => "Přiřadili jste k objednávce č.${total}";
