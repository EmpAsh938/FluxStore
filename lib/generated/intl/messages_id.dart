...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(size) => "Ukuran file maksimum: ${size} MB";
  ...
  static String m27(store) => "Lainnya dari ${store}";

  static String m28(number) => "harus dibeli dalam kelompok ${number}";

  static String m29(itemCount) => "${itemCount} barang";

  static String m30(price) => "Total opsi: ${price}";

  static String m31(amount) => "Bayar ${amount}";

  static String m32(name) => "${name} telah berhasil ditambahkan ke troli";

  static String m33(total) => "Jumlah: ${total}";

  static String m35(percent) => "Diskon ${percent} %";

  static String m36(keyword) => "Hasil penelusuran untuk: \'${keyword}\'";

  static String m37(keyword, count) => "${keyword} (${count} barang)";
  ...
  static String m42(fieldName) => "Bidang ${fieldName} wajib diisi";
  ...
  static String m46(date) => "Berlaku sampai ${date}";
  ...
  static String m50(length) => "Kami menemukan produk ${length}";

  static String m51(week) => "Minggu ${week}";

  static String m52(name) => "Selamat datang ${name}";

  static String m53(year) => "${year} tahun lalu";

  static String m54(total) => "Anda telah menetapkan untuk memesan #${total}";
