...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(size) => "Taille maximale du fichier: ${size} Mo";

  static String m24(currency, amount) =>
      "Le montant minimum pour utiliser ce paiement est de ${currency} ${amount}";

  static String m25(minute) => "Il y a ${minute} minutes";

  static String m26(month) => "Il y a ${month} mois";

  static String m27(store) => "Plus de ${store}";

  static String m28(number) => "doit être acheté par groupes de ${number}";

  static String m29(itemCount) => "${itemCount} produits";

  static String m30(price) => "Total des options: ${price}";

  static String m31(amount) => "Payer ${amount}";

  static String m32(name) => "${name} ont été ajoutés au panier avec succès";

  static String m33(total) => "Qté: ${total}";

  static String m35(percent) => "Remise ${percent} %";

  static String m36(keyword) => "Résultats de recherche pour : \'${keyword}\'";

  static String m37(keyword, count) => "${keyword} (${count}  élément)";

  static String m38(keyword, count) => "${keyword} (${count}  éléments)";

  static String m39(second) => "Il y a ${second} secondes";

  static String m40(totalCartQuantity) =>
      "Panier, ${totalCartQuantity} produits";

  static String m41(numberOfUnitsSold) => "Vendus: ${numberOfUnitsSold}";

  static String m42(fieldName) => "Le champ ${fieldName} est obligatoire";

  static String m43(total) => "${total} Produits";
  ...
  static String m46(date) => "Valable jusqu\'au ${date}";

  static String m48(message) => "Notice: ${message}";
  ...
  static String m50(length) => "Nous avons trouvé ${length} produits";

  static String m51(week) => "Semaine ${week}";

  static String m52(name) => "Bienvenue ${name}";

  static String m53(year) => "Il y a ${year} ans";

  static String m54(total) => "Vous etes affecté à la commande n°${total}";
