...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(size) => "Maksymalny rozmiar pliku: ${size} MB";

  static String m24(currency, amount) =>
      "Minimalna kwota do wykorzystania tej płatności to ${currency} ${amount}";

  static String m25(minute) => "${minute} min temu";

  static String m26(month) => "${month} miesięcy temu";

  static String m27(store) => "Więcej od ${store}";

  static String m28(number) => "należy kupować w grupach po ${number}";

  static String m29(itemCount) => "${itemCount} elementów";

  static String m30(price) => "Łącznie opcje: ${price}";

  static String m31(amount) => "Zapłać ${amount}";

  static String m32(name) => "${name} zostało pomyślnie dodane do koszyka";

  static String m33(total) => "Ilość: ${total}";

  static String m35(percent) => "Wyprzedaż ${percent}%";

  static String m36(keyword) => "Wyniki wyszukiwania dla: \'${keyword}\'";

  static String m37(keyword, count) => "${keyword} (${count} element)";

  static String m38(keyword, count) => "${keyword} (${count} elementy)";

  static String m39(second) => "${second} sekundy temu";

  static String m40(totalCartQuantity) =>
      "Koszyk, ${totalCartQuantity} pozycje";

  static String m41(numberOfUnitsSold) => "Sprzedane: ${numberOfUnitsSold}";

  static String m42(fieldName) => "Pole ${fieldName} jest wymagane";

  static String m43(total) => "${total} produktów";
  ...
  static String m46(date) => "Ważne do ${date}";

  static String m48(message) => "Ostrzeżenie: ${message}";
  ...
  static String m50(length) => "Znaleźliśmy ${length} produktów";

  static String m51(week) => "Tydzień ${week}";

  static String m52(name) => "Witamy ${name}";

  static String m53(year) => "${year} lat temu";

  static String m54(total) => "Przypisałeś do zamówienia nr${total}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "recent": MessageLookupByLibrary.simpleMessage("Niedawny"),
