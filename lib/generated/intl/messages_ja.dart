...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m22(currency, amount) => "このお支払いの最大金額は ${currency} ${amount}です";

  static String m23(size) => "最大ファイルサイズ： ${size} MB";

  static String m24(currency, amount) => "このお支払いの最低金額は ${currency} ${amount}です";

  static String m25(minute) => "${minute}分前";

  static String m26(month) => "${month} か月前";

  static String m27(store) => " ${store}からの詳細";

  static String m28(number) => " ${number}のグループで購入する必要があります";

  static String m29(itemCount) => "${itemCount}個のアイテム";

  static String m30(price) => "オプションの合計： ${price}";

  static String m31(amount) => " ${amount}を支払う";

  static String m32(name) => "${name} がカートに正常に追加されました";

  static String m33(total) => "数量： ${total}";

  static String m35(percent) => "セール${percent}％";

  static String m36(keyword) => "検索結果: 「${keyword}」";

  static String m37(keyword, count) => "${keyword} (${count} 個のアイテム)";

  static String m38(keyword, count) => "${keyword} (${count} 個のアイテム)";
  ...
  static String m41(numberOfUnitsSold) => "販売済み：${numberOfUnitsSold}個";

  static String m42(fieldName) => " ${fieldName} フィールドは必須です";

  static String m43(total) => "${total} 製品";

  static String m45(maxPointDiscount, maxPriceDiscount) =>
      "この注文で最大 ${maxPointDiscount} ポイントを使用すると、 ${maxPriceDiscount} 割引を受けられます。";

  static String m46(date) => " ${date}まで有効";
  ...
  static String m50(length) => "${length} 個の商品が見つかりました";

  static String m51(week) => "週 ${week}";

  static String m52(name) => "ようこそ ${name}";

  static String m53(year) => "${year} 年前";

  static String m54(total) => "注文番号${total}に割り当てました";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "transactionFailed": MessageLookupByLibrary.simpleMessage("処理に失敗しました"),
