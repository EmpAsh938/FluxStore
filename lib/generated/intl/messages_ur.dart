...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(size) => "فائل کا زیادہ سے زیادہ سائز: ${size} MB";

  static String m24(currency, amount) =>
      "اس ادائیگی کو استعمال کرنے کی کم از کم رقم ${currency} ${amount}ہے";

  static String m25(minute) => "${minute} منٹ پہلے";

  static String m26(month) => "${month} مہینے پہلے";

  static String m27(store) => " ${store}سے مزید";

  static String m28(number) => " ${number}کے گروپوں میں خریدنا ضروری ہے";

  static String m29(itemCount) => "${itemCount} آئٹمز";

  static String m30(price) => "کل اختیارات: ${price}";

  static String m31(amount) => "ادائیگی کریں ${amount}";

  static String m32(name) =>
      "${name} کو کارٹ میں کامیابی کے ساتھ شامل کر دیا گیا ہے۔";

  static String m33(total) => "مقدار: ${total}";

  static String m35(percent) => "فروخت ${percent}%";

  static String m36(keyword) => "تلاش کے نتائج برائے: \'${keyword}\'";

  static String m37(keyword, count) => "${keyword} (${count} آئٹم)";

  static String m38(keyword, count) => "${keyword} (${count} آئٹمز)";

  static String m39(second) => "${second} سیکنڈ پہلے";

  static String m40(totalCartQuantity) =>
      "شاپنگ کارٹ، ${totalCartQuantity} آئٹمز";

  static String m41(numberOfUnitsSold) => "فروخت کیا گیا: ${numberOfUnitsSold}";

  static String m42(fieldName) => " ${fieldName} فیلڈ درکار ہے۔";

  static String m43(total) => "${total} مصنوعات";
  ...
  static String m46(date) => " ${date}تک درست";

  static String m48(message) => "انتباہ: ${message}";
  ...
  static String m50(length) => "ہمیں ${length} پروڈکٹس ملے";

  static String m51(week) => "ہفتہ ${week}";

  static String m52(name) => "خوش آمدید ${name}";

  static String m53(year) => "${year} سال پہلے";

  static String m54(total) => "آپ نے آرڈر #${total}کو تفویض کیا ہے";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "recent": MessageLookupByLibrary.simpleMessage("حالیہ"),
