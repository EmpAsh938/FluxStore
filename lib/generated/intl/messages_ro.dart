...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(size) => "Dimensiunea maximă a fișierului: ${size} MB";

  static String m24(currency, amount) =>
      "Suma minimă pentru utilizarea acestei plăți este ${currency} ${amount}";

  static String m25(minute) => "${minute} minute în urmă";

  static String m26(month) => " Acum${month} luni";

  static String m27(store) => "Mai multe de la ${store}";

  static String m28(number) => "trebuie cumpărat în grupuri de ${number}";

  static String m29(itemCount) => "${itemCount} articole";

  static String m30(price) => "Opțiuni totale: ${price}";

  static String m31(amount) => "Plătiți ${amount}";

  static String m32(name) => "${name} au fost adăugate în coș cu succes";

  static String m33(total) => "Cantitate: ${total}";

  static String m35(percent) => "Reducere ${percent} %";

  static String m36(keyword) => "Rezultatele căutării pentru: „${keyword}”";

  static String m37(keyword, count) => "${keyword} (${count} articol)";

  static String m38(keyword, count) => "${keyword} (${count} articole)";

  static String m39(second) => "${second} secunde în urmă";

  static String m40(totalCartQuantity) =>
      "Coș de cumpărături, ${totalCartQuantity} articole";

  static String m41(numberOfUnitsSold) => "Vândut: ${numberOfUnitsSold}";

  static String m42(fieldName) => "Câmpul ${fieldName} este obligatoriu";

  static String m43(total) => "${total} articole";
  ...
  static String m46(date) => "Valabil până la ${date}";

  static String m48(message) => "Atenție: ${message}";
  ...
  static String m50(length) => "Am găsit ${length} articole";

  static String m51(week) => "Săptămâna ${week}";

  static String m52(name) => "Bun venit ${name}";

  static String m53(year) => " Acum${year} ani";

  static String m54(total) => "Ați atribuit comenzii nr.${total}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "approvedRequests":
            MessageLookupByLibrary.simpleMessage("Cereri aprobate"),
        ...
        "branchChangeWarning": MessageLookupByLibrary.simpleMessage(
            "Ne pare rău, coșul de cumpărături va fi golit din cauza schimbării regiunii. Suntem bucuroși să vă contactăm dacă aveți nevoie de asistență."),
        ...
        "cancelledRequests":
            MessageLookupByLibrary.simpleMessage("Cereri anulate"),
        ...
        "loginToReview": MessageLookupByLibrary.simpleMessage(
            "Vă rugăm să vă conectați pentru a revizui"),
        ...
        "noSuggestionSearch":
            MessageLookupByLibrary.simpleMessage("Nu există sugestii"),
        ...
        "paymentSettings":
            MessageLookupByLibrary.simpleMessage("Setări de plată"),
        "paymentSuccessful":
        ...
        "searchEmptyDataMessage": MessageLookupByLibrary.simpleMessage(
            "Hopa! Se pare că niciun rezultat nu corespunde criteriilor dvs. de căutare"),
        ...
        "sizeGuide": MessageLookupByLibrary.simpleMessage("Ghid marimi"),
        ...
        "storeLocatorSearchPlaceholder":
            MessageLookupByLibrary.simpleMessage("Introdu adresa/orașul"),
        "storeLogo":
        ...
        "subTitleOrderConfirmed": MessageLookupByLibrary.simpleMessage(
            "Vă mulțumim pentru comandă. Lucrăm rapid pentru a vă procesa comanda. Rămâneți pe fază pentru un e-mail de confirmare în curând"),
        ...
        "withdrawAmount":
            MessageLookupByLibrary.simpleMessage("Retrageți suma"),
        "withdrawRequest":
            MessageLookupByLibrary.simpleMessage("Cerere de retragere"),
