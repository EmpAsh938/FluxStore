...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(size) => "Mida màxima del fitxer: ${size} MB";

  static String m24(currency, amount) =>
      "L’import mínim per utilitzar aquest pagament és ${currency} ${amount}";

  static String m25(minute) => "fa ${minute} minuts";

  static String m26(month) => "fa ${month} mesos";

  static String m27(store) => "Més de ${store}";

  static String m28(number) => "s\'ha de comprar en grups de ${number}";

  static String m29(itemCount) => "${itemCount} articles";

  static String m30(price) => "Total d’opcions: ${price}";

  static String m31(amount) => "Pagar ${amount}";

  static String m33(total) => "Quantitat: ${total}";

  static String m35(percent) => "Descompte ${percent}%";

  static String m39(second) => "fa ${second} segons";

  static String m40(totalCartQuantity) =>
      "Cistella de compra, ${totalCartQuantity} articles";

  static String m41(numberOfUnitsSold) => "Venuts: ${numberOfUnitsSold}";

  static String m42(fieldName) => "El camp ${fieldName} és obligatori";

  static String m43(total) => "${total} productes";
  ...
  static String m46(date) => "Vàlid fins al ${date}";

  static String m48(message) => "Advertència: ${message}";
  ...
  static String m50(length) => "Hem trobat ${length} productes";

  static String m51(week) => "Setmana ${week}";

  static String m52(name) => "Benvingut/da ${name}";

  static String m53(year) => "fa ${year} anys";

  static String m54(total) => "T’han assignat la comanda #${total}";
