...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(size) => "Maximale Dateigröße: ${size} MB";

  static String m24(currency, amount) =>
      "Der Mindestbetrag für die Verwendung dieser Zahlung beträgt ${currency} ${amount}";

  static String m25(minute) => "Vor ${minute} Minuten";

  static String m26(month) => " Vor${month} Monaten";

  static String m27(store) => "Mehr von ${store}";

  static String m28(number) => "müssen in Gruppen von ${number}gekauft werden";

  static String m29(itemCount) => "${itemCount} Artikel";

  static String m30(price) => "Optionen insgesamt: ${price}";

  static String m31(amount) => "Zahlen Sie ${amount}";

  static String m32(name) =>
      "${name} wurden erfolgreich zum Warenkorb hinzugefügt";

  static String m33(total) => "Menge: ${total}";

  static String m35(percent) => "Ausverkauf ${percent} %";

  static String m36(keyword) => "Suchergebnisse für: \'${keyword}\'";

  static String m37(keyword, count) => "${keyword} (${count} Element)";

  static String m38(keyword, count) => "${keyword} (${count} Artikel)";

  static String m39(second) => "Vor ${second} Sekunden";

  static String m40(totalCartQuantity) =>
      "Warenkorb, ${totalCartQuantity} Artikel";

  static String m41(numberOfUnitsSold) => "Verkauft: ${numberOfUnitsSold}";

  static String m42(fieldName) => "Das Feld ${fieldName} ist erforderlich";
  ...
  static String m46(date) => "Gültig bis ${date}";

  static String m48(message) => "Warnung: ${message}";
  ...
  static String m50(length) => "Wir haben die Produkte gefunden";

  static String m51(week) => "Woche ${week}";

  static String m52(name) => "Willkommen ${name}";

  static String m53(year) => " Vor${year} Jahren";

  static String m54(total) => "Sie haben der Bestellung #${total}zugewiesen";
