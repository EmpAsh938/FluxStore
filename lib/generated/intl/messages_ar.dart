...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(size) => "أقصى حجم للملف: ${size} ميغابايت";

  static String m24(currency, amount) =>
      "الحد الأدنى لمبلغ استخدام هذه الدفعة هو ${currency} ${amount}";

  static String m25(minute) => "${minute} دقائق ماضية";

  static String m26(month) => " قبل${month} شهر";

  static String m27(store) => "المزيد من ${store}";

  static String m28(number) => "يجب شراؤها في مجموعات من ${number}";

  static String m29(itemCount) => "${itemCount} عنصر";

  static String m30(price) => "إجمالي الخيارات: ${price}";

  static String m31(amount) => "ادفع ${amount}";

  static String m32(name) => " تمت إضافة${name} إلى سلة التسوق بنجاح";

  static String m33(total) => "الكمية: ${total}";

  static String m34(name) => "استلمت مالاً من ${name}";

  static String m35(percent) => "بيع ${percent} ٪";

  static String m36(keyword) => "نتائج البحث عن: \'${keyword}\'";

  static String m37(keyword, count) => "${keyword} (عنصر واحد ${count} )";

  static String m38(keyword, count) => "${keyword} (${count} عنصر)";

  static String m39(second) => "${second} ثواني ماضية";

  static String m40(totalCartQuantity) =>
      "سلة التسوق, تحتوي ${totalCartQuantity} عنصر";

  static String m41(numberOfUnitsSold) => "مباع: ${numberOfUnitsSold}";

  static String m42(fieldName) => "الحقل ${fieldName} مطلوب";

  static String m43(total) => "${total} من المنتجات";

  static String m44(name) => "نقل الأموال إلى ${name}";
  ...
  static String m46(date) => "صالح حتى ${date}";

  static String m47(balance) => "رصيد المحفظة: ${balance}";

  static String m48(message) => "تحذير: ${message}";

  static String m49(defaultCurrency) =>
      "العملة المحددة حالياً غير متاحة لميزة المحفظة ، الرجاء تغييرها إلى ${defaultCurrency}";

  static String m50(length) => "تم العثور على${length} منتجاً";

  static String m51(week) => "الأسبوع ${week}";

  static String m52(name) => "مرحبًا ${name}";

  static String m53(year) => " قبل${year} سنة";

  static String m54(total) => "لقد قمت بتعيين الطلب رقم${total}";
