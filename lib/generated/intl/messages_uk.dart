...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(size) => "Максимальний розмір файлу: ${size} МБ";

  static String m24(currency, amount) =>
      "Мінімальна сума для використання цього платежу становить ${currency} ${amount}";

  static String m25(minute) => "${minute} хвилин тому";

  static String m26(month) => "${month} місяців тому";

  static String m27(store) => "Більше від ${store}";

  static String m28(number) => "потрібно купувати групами по ${number}";

  static String m29(itemCount) => "${itemCount} елементів";

  static String m30(price) => "Всього варіантів: ${price}";

  static String m31(amount) => "Сплатити ${amount}";

  static String m32(name) => "${name} успішно додано до кошика";

  static String m33(total) => "Кількість: ${total}";

  static String m35(percent) => "Продаж ${percent}%";

  static String m36(keyword) => "Результати пошуку для: \"${keyword}\"";

  static String m37(keyword, count) => "${keyword} (${count} елемент)";

  static String m38(keyword, count) => "${keyword} (${count} елементів)";

  static String m39(second) => "${second} секунд тому";

  static String m40(totalCartQuantity) =>
      "Кошик, товарів: ${totalCartQuantity} ";

  static String m41(numberOfUnitsSold) => "Продано: ${numberOfUnitsSold}";

  static String m42(fieldName) => "Поле ${fieldName} є обов’язковим";

  static String m43(total) => "${total} продуктів";
  ...
  static String m46(date) => "Діє до ${date}";

  static String m48(message) => "Попередження: ${message}";

  static String m49(defaultCurrency) =>
      "Вибрана валюта зараз недоступна для функції Wallet. Змініть її на ${defaultCurrency}";

  static String m50(length) => "Ми знайшли ${length} продуктів";

  static String m51(week) => "Тиждень ${week}";

  static String m52(name) => "Ласкаво просимо ${name}";

  static String m53(year) => "${year} років тому";

  static String m54(total) => "Ви призначили замовлення №${total}";
