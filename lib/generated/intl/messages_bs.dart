...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(size) => "Maksimalna veličina fajla: ${size} MB";

  static String m24(currency, amount) =>
      "Minimalni iznos za korištenje ove uplate je ${currency} ${amount}";

  static String m25(minute) => "${minute} minuta prije";

  static String m26(month) => "${month} mjeseca prije";

  static String m27(store) => "Više od ${store}";

  static String m28(number) => "mora se kupiti u grupama od ${number}";

  static String m29(itemCount) => "${itemCount} proizvoda";

  static String m30(price) => "Ukupno opcija: ${price}";

  static String m31(amount) => "Plati ${amount}";

  static String m32(name) => "${name} su uspješno dodani u korpu";

  static String m33(total) => "Količina: ${total}";

  static String m35(percent) => "Rasprodaja ${percent}%";

  static String m36(keyword) => "Rezultati pretrage za: \'${keyword}\'";

  static String m37(keyword, count) => "${keyword} (${count} stavka)";

  static String m38(keyword, count) => "${keyword} (${count} stavki)";

  static String m39(second) => "${second} sekundi prije";

  static String m40(totalCartQuantity) =>
      "Korpa za kupovinu, ${totalCartQuantity} proizvoda";

  static String m41(numberOfUnitsSold) => "Prodano: ${numberOfUnitsSold}";
  ...
  static String m46(date) => "Validno do ${date}";

  static String m48(message) => "Upozorenje: ${message}";
  ...
  static String m50(length) => "Pronašli smo ${length} proizvoda";

  static String m51(week) => "Sedmica ${week}";

  static String m52(name) => "Dobro došli ${name}";

  static String m53(year) => "${year} godine prije";

  static String m54(total) => "Dodijeljeni ste narudžbi #${total}";
