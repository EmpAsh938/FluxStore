...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(size) => "Maksimum fayl ölçüsü: ${size} MB";

  static String m24(currency, amount) =>
      "Bu ödənişdən istifadə üçün minimum məbləğ: ${currency} ${amount}";

  static String m25(minute) => "${minute} dəqiqə öncə";

  static String m26(month) => "${month} ay əvvəl";

  static String m27(store) => " ${store}saytından daha çox";

  static String m28(number) => " ${number}qruplarında alınmalıdır";

  static String m29(itemCount) => "${itemCount} məhsul";

  static String m30(price) => "Cəmi seçimlər: ${price}";

  static String m31(amount) => " ${amount}ödəyin";

  static String m32(name) => "${name} səbətə uğurla əlavə edildi";

  static String m33(total) => "Miqdar: ${total}";

  static String m35(percent) => "Endirim ${percent}%";

  static String m36(keyword) => "Axtarış nəticələri: \'${keyword}\'";

  static String m37(keyword, count) => "${keyword} (${count} element)";

  static String m38(keyword, count) => "${keyword} (${count} element)";

  static String m39(second) => "${second} saniyə öncə";

  static String m40(totalCartQuantity) =>
      "Səbətdə ${totalCartQuantity} məhsul var";

  static String m41(numberOfUnitsSold) => "Satıldı: ${numberOfUnitsSold}";

  static String m42(fieldName) => " ${fieldName} sahəsi tələb olunur";

  static String m43(total) => "${total} məhsul";
  ...
  static String m46(date) => " ${date}tarixinə qədər etibarlıdır";

  static String m48(message) => "Xəbərdarlıq: ${message}";
  ...
  static String m50(length) => "${length} məhsul tapıldı";

  static String m51(week) => "Həftə ${week}";

  static String m52(name) => "Xoş gəldiniz ${name}";

  static String m53(year) => "${year} il əvvəl";

  static String m54(total) => "Siz №${total}sifarişi təyin etdiniz";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "recent": MessageLookupByLibrary.simpleMessage("Hazırki"),
