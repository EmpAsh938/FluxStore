...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(size) => "Maksimalna veličina datoteke: ${size} MB";

  static String m24(currency, amount) =>
      "Минимални износ за коришћење ове уплате је ${currency} ${amount}";

  static String m25(minute) => "Пре ${minute} Minuten";

  static String m26(month) => " Prije${month} mjeseci";

  static String m27(store) => "Više od ${store}";

  static String m28(number) => "мора се купити у групама од ${number}";

  static String m29(itemCount) => "${itemCount} Ставка";

  static String m30(price) => "Укупно опција: ${price}";

  static String m31(amount) => "Плати ${amount}";

  static String m32(name) => "${name} је успешно додат у корпу";

  static String m33(total) => "Količina: ${total}";

  static String m35(percent) => "Распродај ${percent} %";

  static String m36(keyword) => "Резултати претраге за: \'${keyword}\'";

  static String m37(keyword, count) => "${keyword} (${count} ставка)";

  static String m38(keyword, count) => "${keyword} (${count} ставки)";

  static String m39(second) => "Пре ${second} Минута";

  static String m40(totalCartQuantity) =>
      "корпа, ${totalCartQuantity} предмета";

  static String m41(numberOfUnitsSold) => "продато: ${numberOfUnitsSold}";

  static String m42(fieldName) => "Polje ${fieldName} je obavezno";

  static String m43(total) => "${total} proizvoda";
  ...
  static String m46(date) => "Датум истека ${date}";

  static String m48(message) => "упозорење: ${message}";
  ...
  static String m50(length) => "Пронашли смо производе";

  static String m51(week) => " ${week}. Sedmica";

  static String m52(name) => "Добро дошли ${name}";

  static String m53(year) => " Prije${year} godina";

  static String m54(total) => "Dodijelili ste narudžbi br.${total}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "recent": MessageLookupByLibrary.simpleMessage("Недавно"),
        "recentSearches":
