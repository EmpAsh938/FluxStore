...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(size) => "Максимальный размер файла: ${size} МБ";

  static String m24(currency, amount) =>
      "Минимальная сумма для использования этого платежа: ${currency} ${amount}";

  static String m25(minute) => "${minute} минут назад";

  static String m26(month) => "${month} месяцев назад";

  static String m27(store) => "Еще от ${store}";

  static String m28(number) => "необходимо покупать группами по ${number}";

  static String m29(itemCount) => "${itemCount} товаров";

  static String m30(price) => "Всего вариантов: ${price}";

  static String m31(amount) => "Оплатить ${amount}";

  static String m32(name) => "${name} успешно добавлено в корзину";

  static String m33(total) => "Кол-во: ${total}";

  static String m35(percent) => "Распродажа ${percent} %";

  static String m36(keyword) => "Результаты поиска для: \'${keyword}\'";

  static String m37(keyword, count) => "${keyword} (элемент${count} )";

  static String m38(keyword, count) => "${keyword} (${count} шт.)";

  static String m39(second) => "${second} секунд назад";
  ...
  static String m42(fieldName) =>
      "Поле ${fieldName} обязательно для заполнения";

  static String m43(total) => "${total} продуктов";
  ...
  static String m46(date) => "Действительно до ${date}";

  static String m48(message) => "Предупреждение: ${message}";
  ...
  static String m50(length) => "Мы нашли товары";

  static String m51(week) => "Неделя ${week}";

  static String m52(name) => "Добро пожаловать ${name}";

  static String m53(year) => "${year} лет назад";

  static String m54(total) => "Вы назначили заказ №${total}";
