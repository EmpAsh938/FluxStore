...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(size) => "အကြီးဆုံးလက်ခံနိုင်သည့်ဖိုင်ဆိုဒ်: ${size} MB";
  ...
  static String m26(month) => "${month} လအကြာက";

  static String m27(store) => " ${store}မှ နောက်ထပ်";

  static String m28(number) => " ${number}အုပ်စုဖြင့် ဝယ်ယူရမည်";

  static String m29(itemCount) => "${itemCount} items";

  static String m30(price) => "Options total: ${price}";

  static String m31(amount) => " ${amount}ပေးချေပါ";
  ...
  static String m36(keyword) => "ရှာဖွေမှုရလဒ်များ- \'${keyword}\'";

  static String m37(keyword, count) => "${keyword} (ပစ္စည်း${count} ခု)";

  static String m38(keyword, count) => "${keyword} (ပစ္စည်း${count} ခု)";
  ...
  static String m42(fieldName) => " ${fieldName} အကွက် လိုအပ်သည်။";
  ...
  static String m48(message) => "သတိပေးချက်: ${message}";
  ...
  static String m52(name) => "ကြိုဆိုပါတယ် ${name}";

  static String m53(year) => "${year} နှစ်အကြာက";
