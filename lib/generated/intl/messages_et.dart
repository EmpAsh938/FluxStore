...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(size) => "Maksimaalne faili suurus: ${size} MB";

  static String m24(currency, amount) =>
      "Selle makse kasutamiseks on miinimumsumma ${currency} ${amount}";

  static String m25(minute) => "${minute} minutit tagasi";

  static String m26(month) => "${month} kuud tagasi";

  static String m27(store) => "Rohkem ${store} poest";

  static String m28(number) => "tuleb osta rühmadena ${number}";

  static String m29(itemCount) => "${itemCount} toodet";

  static String m30(price) => "Valikute kogusumma: ${price}";

  static String m31(amount) => "Maksa ${amount}";

  static String m33(total) => "Kogus: ${total}";

  static String m35(percent) => "Müügil ${percent}%";

  static String m39(second) => "${second} sekundit tagasi";

  static String m40(totalCartQuantity) =>
      "Ostukorv, ${totalCartQuantity} toodet";

  static String m41(numberOfUnitsSold) => "Müüdud: ${numberOfUnitsSold}";

  static String m42(fieldName) => "${fieldName} väli on kohustuslik";

  static String m43(total) => "${total} toodet";
  ...
  static String m46(date) => "Kehtiv kuni ${date}";

  static String m48(message) => "Hoiatus: ${message}";
  ...
  static String m50(length) => "Leidsime ${length} toodet";

  static String m51(week) => "Nädal ${week}";

  static String m52(name) => "Tere tulemast, ${name}";

  static String m53(year) => "${year} aastat tagasi";

  static String m54(total) => "Olete määranud tellimusele #${total}";
