...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m23(size) => "גודל קובץ מקסימלי: ${size} מגה בייט";

  static String m24(currency, amount) =>
      "הסכום המינימלי לשימוש בתשלום זה הוא ${currency} ${amount}";

  static String m25(minute) => "לפני {דקה} דקות";

  static String m26(month) => " לפני${month} חודשים";

  static String m27(store) => "עוד מ- ${store}";

  static String m28(number) => "יש לקנות בקבוצות של ${number}";

  static String m29(itemCount) => "${itemCount} פריטים";

  static String m30(price) => "סה\"כ אפשרויות: ${price}";

  static String m31(amount) => "שלם ${amount}";

  static String m32(name) => "${name} נוספו לעגלת הקניות בהצלחה";

  static String m33(total) => "כמות: ${total}";

  static String m35(percent) => "הנחה ${percent}%";

  static String m36(keyword) => "תוצאות חיפוש עבור: \'${keyword}\'";

  static String m37(keyword, count) => "${keyword} (${count} פריט)";

  static String m38(keyword, count) => "${keyword} (${count} פריטים)";

  static String m39(second) => "לפני ${second} שניות";

  static String m40(totalCartQuantity) =>
      "עגלת קניות, ${totalCartQuantity} פריטים";

  static String m41(numberOfUnitsSold) => "נמכר: ${numberOfUnitsSold}";

  static String m42(fieldName) => "השדה ${fieldName} נדרש";

  static String m43(total) => "${total} מוצרים";
  ...
  static String m46(date) => "תקף עד ${date}";

  static String m48(message) => "אזהרה: ${message}";

  static String m49(defaultCurrency) =>
      "המטבע שנבחר כרגע אינו זמין עבור תכונת הארנק, שנה אותו ל- ${defaultCurrency}";

  static String m50(length) => "מצאנו ${length} מוצרים";

  static String m51(week) => "שבוע ${week}";

  static String m52(name) => "ברוך הבא ${name}";

  static String m53(year) => " לפני${year} שנים";

  static String m54(total) => "הקצית להזמין מספר${total}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "recent": MessageLookupByLibrary.simpleMessage("לאחרונה"),
